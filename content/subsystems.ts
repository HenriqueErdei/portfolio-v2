...
/**
 * Níveis alinhados ao Skills.tsx do portfólio anterior (percentuais → 1–5).
 * Soft skills sem ícone Simple Icons estável ficaram de fora.
 */
export const subsystems: readonly Subsystem[] = [
  ...
  { name: "TypeScript", slug: "typescript", color: "#3178C6", level: 3, since: 2023, group: "guidance" },
  { name: "JavaScript", slug: "javascript", color: "#F7DF1E", level: 3, since: 2022, group: "guidance" },

  // Back-end e dados / structure
  { name: "Power BI", slug: "powerbi", color: "#F2C811", level: 5, since: 2023, group: "structure" },
  { name: "Flask", slug: "flask", color: "#6B7280", level: 5, since: 2025, group: "structure" },
  { name: "Pandas", slug: "pandas", color: "#8A6FE8", level: 5, since: 2024, group: "structure" },
  { name: "SQLite", slug: "sqlite", color: "#003B57", level: 4, since: 2025, group: "structure" },
  { name: "MySQL", slug: "mysql", color: "#4479A1", level: 4, since: 2024, group: "structure" },
  ...
  { name: "CSS", slug: "css", color: "#663399", level: 5, since: 2022, group: "propulsion" },
  { name: "React", slug: "react", color: "#61DAFB", level: 3, since: 2025, group: "propulsion" },
  ...
  { name: "AWS", slug: "amazonaws", color: "#FF9900", level: 4, since: 2024, group: "ground" },
  { name: "Docker", slug: "docker", color: "#2496ED", level: 4, since: 2024, group: "ground" },
  { name: "Vite", slug: "vite", color: "#646CFF", level: 3, since: 2025, group: "ground" },
  { name: "Jira", slug: "jira", color: "#0052CC", level: 5, since: 2023, group: "ground" },
]
